  ...
  return (
    <div>
      <button onClick={() => { setToggleForm(!toggleForm) }}
        className={`bg-yellow-400 text-black px-2 py-3 w-full text-left rounded-t-md hover:bg-yellow-200
        ${toggleForm ? 'rounded-t-md' : 'rounded-md'}`}>
        <div><BiCalendarPlus className="inline-block align-text-top" />   Add To-Do</div>
      </button>
      {
        toggleForm &&
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <input type="text" name="petName" id="petName"
                ...
                className="max-w-lg block w-full shadow-sm focus:ring-yellow-500 focus:border-indigo-500 sm:max-w-xs sm:text-sm border-gray-300 rounded-md" />
            </div>
          </div>
          ...
          <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start  sm:pt-5">
            ...
            <div className="mt-1 sm:mt-0 sm:col-span-2">
              <textarea id="aptNotes" name="aptNotes" rows="3"
                ...
                className="shadow-sm focus:ring-indigo-500 focus:border-yellow-500 mt-1 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="About the to-do event"></textarea>
            </div>
          </div>

          <div className="pt-5">
            <div className="flex justify-end">
              <button type="submit" onClick={formDataPublish} className="ml-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400">
                Submit
            </button>
            </div>
          </div>
